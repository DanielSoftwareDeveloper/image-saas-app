      ...
      <div className="p-4 md:p-6 lg:px-8 space-y-6">
          ...
          <CardContent>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <Button
                ...
                variant="outline"
                className="group h-auto flex-col gap-2 cursor-pointer"
              >
              ...
              <Button
                ...
                variant="outline"
                className="group hover:bg-muted h-auto flex-col gap-2 p-6 cursor-pointer"
              >
                <ImageIcon className="h-8 w-8 transition-transform group-hover:scale-110" />
                <div className="text-center">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="flex items-center gap-2">
              <ImageIcon className="h-5 w-5 text-purple-600 dark:text-violet-400" />
              Recent Image Projects
            </CardTitle>
            {imageProjects.length > 0 && (
              <Button
                ...
                size="sm"
                onClick={() => router.push("/dashboard/projects")}
                className="cursor-pointer text-purple-600 hover:text-purple-700 dark:text-violet-400 dark:hover:text-purple-500"
              >
